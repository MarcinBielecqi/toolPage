...
! function () {
	Date.now();
	window.windySentErrors = [], window.onerror = e.bind(null, "error");
	try {
		new Float32Array(100)
	} catch (t) {
		return e("startup", "Type Array not supported", null, null, null, t, "errorLogger"), void document.addEventListener("DOMContentLoaded",
			function () {
				document.getElementById("not-supported").style.display = "block"
			})
	}

	function e(e, t, n, i, s, a, r) {
		W.rootScope, Date.now()
	}
	window.wError = function (t, n, i) {
		console.error(t, n, i), e("user", n, null, null, null, i, t)
	}
}(),
/*!
...
function (e) {
	...
	function n(i) {
		...
		return i.name && (i.name in e ? window.wError("tinyrequire", "DI error: Object W." + i.name + " already exists") : e[i.name] = i.loaded),
			i.loaded
	}
	var i = {};
...
L.CanvasLayer = L.Layer.extend({
		...
		onAdd: function (e) {
			...
			if (this._canvas = L.DomUtil.create("canvas", "leaflet-canvas"), this.onResizeCanvas(t.x, t.y), L.DomUtil.addClass(this._canvas,
					"leaflet-layer leaflet-zoom-" + (n ? "animated" : "hide")), e.getPanes()[this.targetPane].appendChild(this._canvas), !this.onCreateCanvas(
					this._canvas)) return this.failed = !0, void this.onCanvasFailed();
			e.on("resize", this._resize, this), e.on("zoomanim", this._animateZoom, this), e.on("zoom", this._onZoom, this), e.on("zoomstart",
				this._onZoomStart, this), e.on("zoomend", this._onZoomEnd, this), this.options.disableAutoReset || e.on("moveend", this._moveEnd,
				this), this._reset(), this._redraw()
		},
		onRemove: function (e) {
			this.onRemoveCanvas(this._canvas), e.getPanes()[this.targetPane].removeChild(this._canvas), e.off("resize", this._resize, this), e.off(
				"zoomanim", this._animateZoom, this), e.off("zoom", this._onZoom, this), e.off("zoomstart", this._onZoomStart, this), e.off(
				"zoomend", this._onZoomEnd, this), this.options.disableAutoReset || e.off("moveend", this._moveEnd, this), this._canvas = null
		},
		getCanvas: function () {
			return this._canvas
		},
		...
		_animateZoom: function (e) {
			...
			L.DomUtil.setTransform ? L.DomUtil.setTransform(this._canvas, n, t) : this._canvas.style[L.DomUtil.TRANSFORM] = L.DomUtil.getTranslateString(
				n) + " scale(" + t + ")"
		},
		_onZoom: function () {
		...
		_updateTransform: function (e, t) {
			...
			L.DomUtil.setTransform ? L.DomUtil.setTransform(this._canvas, o, n) : this._canvas.style[L.DomUtil.TRANSFORM] = L.DomUtil.getTranslateString(
				o) + " scale(" + n + ")"
		},
		onInit: function () {},
		...
		onAdd: function (e) {
			this._map = e, this.displayed = !0, this._container || (this._container = L.DomUtil.create("div", "leaflet-layer windy-pois pois-" +
				this.className)), this.getPane().appendChild(this._container), this._map.on("viewreset", this._reset, this), this._reset(), this._markers = {}
		},
		...
		forAllMarkers: function (e, t) {
			for (var n, i, s, a = this.getAllMarkers(), r = a.length, o = 0; o < r; o++) n = a[o], (s = this._markers[n.dataset.id]) && (i = e(s,
				t), this.setPoistion(n, i))
		},
	...
	W.define("Evented", ["Class"], function (e) {
		...
		var t = window.W.windyBoot.options.verbose;
		if (t) var n = 0,
			i = ["red", "darkcyan", "green", "orange", "darkblue", "violet", "darkgreen", "blue", "brown", "blueviolet", "coral", "darkcyan",
				"midnightblue"
			];
		var s = [];
		return W.latestBcasts = s, e.extend({
			_init: function () {
				this.latestId = 1, this._eventedCache = {}, t && (this.terminalColor = i[n], ++n > i.length - 1 && (n = 0)), this.trigger = this.emit,
					this.fire = this.emit
			},
			emit: function (e, n, i, a, r) {
				var o, l, c;
				t && console.log("%c" + this.ident + ": " + e, "color:" + this.terminalColor, n || "", i || "", a || "", r || ""), o = this.ident,
					l = e, c = n, s.push({
						ts: Date.now(),
						txt: o + ": " + l + ("string" == typeof c ? " " + c : "")
					}), s.length > 5 && s.shift();
				var d = this._eventedCache[e];
				if (d)
					for (var u = d.length; u--;) {
						var h = d[u];
						try {
							h.callback.call(h.context, n, i, a, r), h.once && this.off(h.id)
						} catch (t) {
		...
		var c = function (e) {
			...
			u = function (e, o, l) {
				...
				var m = /^\/?users\//.test(o) || l.withCredentials,
					p = o;
				if (void 0 === l.cache && "get" === e && (l.cache = !0), l.cache && (u = s.get(o))) return Promise.resolve(u) == u ? u : Promise.resolve(
					c(u));
				var g = new XMLHttpRequest,
					v = !1;
				if (!/^http/.test(o) && !/^v\/\d+/.test(o) && (o = n.joinPath(t.nodeServer, o), /node\.windy/.test(o) && (o = n.addQs(o, a + "&poc=" +
						++r)), /^\/?forecast\//.test(p))) {
				...
				o = encodeURI(o), g.open(e, o, !0), l.binary && (g.responseType = "arraybuffer"), m && (g.withCredentials = !0), g.setRequestHeader(
					"Accept", d), h = new Promise(function (e, t) {
					var n, a = {},
						r = {};
						...
						if (4 === g.readyState)
							if (l.parseHeaders && g.getAllResponseHeaders().split(/\n/).forEach(function (e) {
								...
								r = {
									status: g.status,
									headers: a
								}, l.binary ? r.data = g.response : v ? (r.isJSON = !0, r.data = window.atob(g.responseText)) : (r.isJSON = /json/.test(g.getResponseHeader(
									"Content-Type")), r.data = g.responseText), l.cache && s.put(p, r);
								var o = c(r);
								e(o)
	...
	W.define("storage", ["rootScope", "http", "utils"], function (e, t, n) {
		var i, s = {
			...
			getFile: function (n, i) {
				...
				void 0 === i && (i = {});
				var a = this.get(n);
				return a && (i.aboluteURL || a.version === e.version) && (!i.test || a.data && a.data[i.test]) ? Promise.resolve(a.data) : new Promise(
					function (a, r) {
						t.get(i.aboluteURL ? n : e.assets + "/" + n).then(function (t) {
							t.version = i.aboluteURL ? "notAplicable" : e.version, !i.test || i.test in t.data ? (s.put(n, t), a(t.data)) : r(
								"File did not passed the test")
						}).catch(function (e) {
	...
	W.define("lruCache", [], function () {
		...
		return e.prototype.put = function (e, t) {
			...
			if (this._keymap[e] = n, this.tail ? (this.tail.newer = n, n.older = this.tail) : this.head = n, this.tail = n, this.size === this.limit)
				return this.shift();
			this.size++
			...
			var e = this.head;
			return e && (this.head.newer ? (this.head = this.head.newer, this.head.older = void 0) : this.head = void 0, e.newer = e.older = void 0,
				delete this._keymap[e.key]), e
		}, e.prototype.get = function (e, t) {
			var n = this._keymap[e];
			if (void 0 !== n) return n === this.tail ? t ? n : n.value : (n.newer && (n === this.head && (this.head = n.newer), n.newer.older = n.older),
				n.older && (n.older.newer = n.newer), n.newer = void 0, n.older = this.tail, this.tail && (this.tail.newer = n), this.tail = n, t ?
				n : n.value)
		}, e.prototype.remove = function (e) {
			var t = this._keymap[e];
			if (t) return delete this._keymap[t.key], t.newer && t.older ? (t.older.newer = t.newer, t.newer.older = t.older) : t.newer ? (t.newer
					.older = void 0, this.head = t.newer) : t.older ? (t.older.newer = void 0, this.tail = t.older) : this.head = this.tail = void 0,
				this.size--, t.value
	...
	W.define("ga", ["rootScope", "store", "utils"], function (e, t, n) {
		...
		var r = !0,
			o = function (t) {
				var n = "dp=" + t + "&dl=https://ai4.windy.com/&" + s;
				...
				setTimeout(function () {
					...
					e.open("HEAD", "https://node.windy.com/sedlina/ga/" + a + "?" + n, !0), e.send(null)
				}, 100)
			};
		return {
			pageview: o
	...
	W.define("utils", ["rootScope"], function (e) {
		...
		return t.num2char = function (e) {
			...
			}, t.emptyFun = function () {}, t.emptyGIF = "data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///ywAAAAAAQABAAACAUwAOw==", t.isValidLatLonObj =
			function (e) {
				...
				return t.hasDirection(e) ? '<div class="iconfont" style="transform: rotate(' + e.dir + "deg); -webkit-transform:rotate(" + e.dir +
					'deg);">"</div>' : ""
				...
				i.style.display = "none", document.body.appendChild(i), i.href = window.URL.createObjectURL(s), i.setAttribute("download", n), i.click(),
					window.URL.revokeObjectURL(i.href), document.body.removeChild(i)
			}, t
	}), /*! */
	W.define("format", ["trans", "store", "utils"], function (e, t, n) {
		...
		i.getDirFunction = function () {
			...
			return (t.useAgo && i ? "in " : "") + (s < 60 ? Math.floor(s) + "m" : Math.floor(s / 60) + "h " + Math.floor(s % 60) + "m") + (t.useAgo &&
				!i ? " ago" : "")
		};
		var c = function (e) {
	...
	W.define("supportedLanguages", [], function () {
		return ["en", "zh-TW", "zh", "ja", "fr", "ko", "it", "ru", "nl", "cs", "tr", "pl", "sv", "fi", "ro", "el", "hu", "hr", "ca", "da", "ar",
			"fa", "hi", "ta", "sk", "uk", "bg", "he", "is", "lt", "et", "vi", "sl", "sr", "id", "th", "sq", "pt", "nb", "es", "de", "bn"
		]
	}), /*! */
	W.define("Calendar", ["format", "utils", "trans", "Class"], function (e, t, n, i) {
		return i.extend({
			...
			_init: function () {
				this.midnight = this.getMidnight(), this.startOfTimeline = this.startOfTimeline || this.midnight, this.start = this.startOfTimeline
					.getTime(), this.days = [], this.endOfcalendar = this.add(this.startOfTimeline, this.calendarHours), this.endOfCal = this.endOfcalendar
					.getTime(), this.maxTimestamp = this.endOfcalendar.getTime(), this.type = this.endOfcalendar < this.midnight ? "historical" : this
					.startOfTimeline < this.midnight ? "mixed" : "forecast", this.timestamps = [], this.paths = [], this.interTimestamps = [], this.minifestFile &&
					this.createTimestampsFromMinifest(this.minifestFile) ? this.minifestValid = !0 : (this.createTimestamps(), this.minifestValid = !1),
				...
				for (var l = 1; l < this.paths.length; l++) this.interTimestamps.push(this.timestamps[l - 1] + Math.floor((this.timestamps[l] -
					this.timestamps[l - 1]) / 2));
				return this
			},
			add: function (e, n, i) {
			...
			prepareTimesFromMinifest: function (e) {
				return e && "object" == typeof e && e.ref && (e.dst || e.dstTime) ? (this.refTime = e.ref.replace(/(\d+)-(\d+)-(\d+)T(\d+):.*/,
					"$1$2$3$4"), this.refTimeTxt = e.ref, this.updateTxt = e.update, this.refTimeTs = new Date(e.ref).getTime(), this.updateTs = new Date(
					e.update).getTime(), !0) : (window.wError("Calendar", "Invalid format of minifest " + (e.dst ? "2.0" : "3.0")), !1)
			},
	...
	W.define("Metric", ["store", "broadcast", "Class"], function (e, t, n) {
		return n.extend({
			...
			renderLegend: function (e, t, n) {
				...
				t.dataset.overlay = this.ident, t.classList[this.howManyMetrics() > 1 ? "remove" : "add"]("one-metric"), t.style.background =
					"linear-gradient(to right, " + l.join(",") + ")", t.innerHTML = d
			}
		})
	}), /*! */
	W.define("Color", ["utils", "store", "Class"], function (e, t, n) {
		return n.extend({
			...
			getGradientColorYUVA: function (e, t, n) {
				for (var i = this.rgba2yuva(this.getMulArray(e, 1 / 255)), s = this.rgba2yuva(this.getMulArray(t, 1 / 255)), a = this.gradYuva(i, s,
						n, !0), r = this.yuva2rgba(a), o = 0; o < r.length; o++) r[o] = Math.max(0, Math.min(256 * r[o], 255));
				return r
			},
			...
			createGradientArray: function (e, t, n) {
				...
				var i, s, a, r, o = this.steps + 1,
					...
					f = u[0],
					m = u[h++];
				for (r = 0; r < this.steps; r++)(i = (this.min + c * r) * n) > m[0] && h < u.length && (f = m, m = u[h++]), a = (i - f[0]) / (m[0] -
					f[0]), s = this.getGradientColorYUVA(f[1], m[1], a), t && this.makePremultiplied(s), l[d++] = Math.round(s[0]), l[d++] = Math.round(
					s[1]), l[d++] = Math.round(s[2]), l[d++] = e ? 255 : Math.round(s[3]);
			...
			combinedArray: function (t, n, i, s) {
				...
				for (var a, r, o = t.length, l = new Uint8Array(o), c = 0; c < o;) {
					for (r = i * ((r = (.299 * t[c] + .587 * t[c + 1] + .114 * t[c + 2]) / (.299 * n[c] + .587 * n[c + 1] + .114 * n[c + 2])) - 1), r +=
						1, a = 0; a < 3; a++) l[c + a] = e.bound(Math.round(r * n[c + a] * (1 - s) + s * t[c + a]), 0, 255);
					l[c + 3] = t[c + 3], c += 4
				}
				return l
			},
			getColor: function () {
				var e = this;
				return this.colors ? this : (this.gradient = t.get(this.key), this.setMinMax(), this.colors = this.createGradientArray(this.opaque),
					this.startingValue = this.min, this.maxIndex = this.steps - 1 << 2, this.step = (this.max - this.startingValue) / this.steps,
					this.value2index = function (t) {
	...
	W.define("Product", ["utils", "rootScope", "http", "store", "Class", "Calendar", "Window", "rhMessage"], function (e, t, n, i, s, a, r, o) {
		return s.extend({
			...
			_init: function () {
				var e;
				this.productExpires = 0, this.minifest = {}, this.pathGenerator = (e = {}, e[2] =
					"{server}/{directory}/{path}/257w<z>/<y>/<x>/{filename}-{level}.{fileSuffix}", e[3] =
					"{server}/im/v3.0/forecast/{directory}/{refTime}/{path}/wm_grid_257/<z>/<x>/<y>/{filename}-{level}.{fileSuffix}", e)[this.imVersion]
			},
			refTime: function () {
			...
			open: function () {
				var e = this;
				return t.isMobileOrTable || this.printLogo(), this.loadingPromise ? this.loadingPromise : Date.now() < this.productExpires ?
					Promise.resolve(this.calendar) : (this.loadingPromise = new Promise(function (t) {
			...
			isInBounds: function (e) {
				return !this.bounds || e.west > this.bounds.west && e.east < this.bounds.east && e.north < this.bounds.north && e.south > this.bounds
					.south
			},
			pointIsInBounds: function (e) {
				return !this.bounds || +e.lon > this.bounds.west && +e.lon < this.bounds.east && +e.lat < this.bounds.north && +e.lat > this.bounds
					.south
			},
			printLogo: function () {
				o.clear(), this.logo && (this.logoEl || (this.logoEl = document.createElement("div"), this.logoEl.innerHTML = this.logo, this.logoEl
					.className = "rh-absoluted rh-transparent"), o.insert(this.logoEl))
			},
			removeLogo: function () {
	...
	W.define("Layer", ["Class", "products", "utils", "rootScope", "store"], function (e, t, n, i, s) {
		return e.extend({
			...
			getParams: function (e, a) {
				...
				if (c.hasMoreLevels ? l.includes(c.level) || (c.level = l[0]) : c.level = "surface", "100m" === c.level && "wind" !== c.overlay &&
					(c.level = "surface"), this.renderParams && (c = Object.assign(c, this.renderParams)), c.refTime = o.refTime(), this.product &&
					/^cams/.test(a) && this.product !== a) {
					var d = t.ecmwf.calendar;
					c.path = d.ts2path(s.get("timestamp")), c.refTime = d.refTime, c.level = this.levels && this.levels[0] || c.level
				}
				return c.fullPath = n.template(this.pathGenerator || o.pathGenerator, c), c.imVersion < 3 && (c.fullPath = n.addQs(c.fullPath,
					"reftime=" + c.refTime)), c
			}
		})
	}), /*! */
	W.define("Overlay", ["layers", "trans", "Class"], function (e, t, n) {
		return n.extend({
			...
			_init: function () {
				...
				if (t) {
					var n = t.m;
					n && (this.convertValue = n.convertValue.bind(n), this.convertNumber = n.convertNumber.bind(n), this.setMetric = n.setMetric.bind(
						n), this.cycleMetric = n.cycleMetric.bind(n), this.listMetrics = n.listMetrics.bind(n), this.m = n), this.c = t.c, this.l = t.l
				}
			},
		...
		return {
			...
			wind: e.instance({
				...
				conv: {
					...
					bft: {
						conversion: function (e) {
							return e < .3 ? 0 : e < 1.5 ? 1 : e < 3.3 ? 2 : e < 5.5 ? 3 : e < 8 ? 4 : e < 10.8 ? 5 : e < 13.9 ? 6 : e < 17.2 ? 7 : e < 20.7 ?
								8 : e < 24.5 ? 9 : e < 28.4 ? 10 : e < 32.6 ? 11 : 12
						},
						precision: 0
					},
					"m/s": {
	...
	W.define("models", ["store", "broadcast", "$", "rootScope", "products", "layers", "overlays"], function (e, t, n, i, s, a, r) {
		...
		return {
			...
			getProduct: function (t, n) {
				...
				return 2 === a.length && a.includes("cams") ? s.camsEu.pointIsInBounds(i.map) ? "camsEu" : "cams" : a.includes(n) ? n : a.includes(r) ?
					r : a.includes("ecmwfWaves") && "ecmwf" === r ? "ecmwfWaves" : a.includes("gfsWaves") && "gfs" === r ? "gfsWaves" : a[0]
			},
			layer2product: l,
			overlay2product: c,
	...
	W.define("products", ["Product", "StaticProduct", "Calendar", "$", "rootScope", "radar", "satellite"], function (e, t, n, i, s, a, r) {
		var o = {},
			...
			c =
			"© Generated using Copernicus Atmosphere Monitoring Service Information [2019]. Neither the European Commission nor ECMWF is responsible for any use of this information.";
		o.ecmwf = e.instance({
			ident: "ecmwf",
			...
			overlays: ["snowcover", "wind", "temp", "pressure", "clouds", "lclouds", "mclouds", "hclouds", "rh", "gust", "cbase", "cape",
				"dewpoint", "rain", "visibility", "deg0", "cloudtop", "thunder", "snowAccu", "rainAccu", "ptype", "sst", "gustAccu"
			],
			acTimes: ["next12h", "next24h", "next3d", "next5d", "next10d"],
			isolines: ["pressure", "gh", "temp", "deg0"],
			_init: function () {
				e._init.call(this), this.createBackupMinifest()
			}
		}), o.cams = e.instance({
			ident: "cams",
			provider: "Copernicus",
			...
			levels: ["surface", "100m", "975h", "950h", "925h", "900h", "850h", "800h", "700h", "600h", "500h", "400h", "300h", "250h", "200h",
				"150h"
			],
			overlays: ["wind", "temp", "pressure", "clouds", "rh", "gust", "dewpoint", "rain", "lclouds", "mclouds", "hclouds", "snowAccu",
				"rainAccu", "ptype", "gustAccu", "cape"
			],
			acTimes: ["next12h", "next24h", "next3d", "next5d", "next10d"],
			...
			levels: ["surface", "950h", "925h", "900h", "850h", "800h", "700h", "600h", "500h", "400h", "300h", "250h", "200h", "150h"],
			overlays: ["snowcover", "wind", "temp", "pressure", "clouds", "lclouds", "mclouds", "hclouds", "rh", "gust", "cape", "dewpoint",
				"rain", "deg0", "snowAccu", "rainAccu", "ptype", "gustAccu"
			],
		...
		var d = e.extend({
			...
			overlays: ["wind", "temp", "clouds", "rh", "gust", "pressure", "dewpoint", "rain", "lclouds", "hclouds", "mclouds", "snowAccu",
				"rainAccu", "ptype", "gustAccu"
			],
	...
	W.define("detectDevice", [], function () {
		var e, t, n, i, s = window.navigator.userAgent,
			...
			r = (e = window.screen.width, t = window.screen.height, n = Math.max(e, t), i = Math.min(e, t), n <= 600 || n <= 960 && i <= 600 ?
				"mobile" : n <= 1024 || 1024 === i && "ios" === a ? "tablet" : "desktop");
		return {
			platform: a,
			device: r
		}
	...
	W.define("rootScope", ["supportedLanguages", "detectDevice"], function (e, t) {
		var n = t.platform,
			...
			a = {
				...
				pointForecast: "v2.5",
				iconsDir: "img/icons4",
				overlays: ["radarSat", "radar", "satellite", "wind", "gust", "gustAccu", "rain", "rainAccu", "snowAccu", "snowcover", "ptype",
					"thunder", "temp", "dewpoint", "rh", "deg0", "clouds", "hclouds", "mclouds", "lclouds", "fog", "cloudtop", "cbase", "visibility",
					"cape", "waves", "swell1", "swell2", "swell3", "wwaves", "sst", "currents", "airQ", "no2", "pm2p5", "aod550", "gtco3", "cosc",
					"dustsm", "so2sm", "pressure", "efiWind", "efiTemp", "efiRain", "capAlerts", "map"
				],
	...
	W.define("store", ["dataSpecifications", "storage", "rootScope", "Evented", "broadcast"], function (e, t, n, i, s) {
		var a = {},
			...
			u = function (e, i, s, o) {
				if (null === o ? delete a[e] : a[e] = o, i.save && !s.doNotStore && t.isAvbl) {
					...
					t.put("settings_" + e, o), i.sync && (t.put("settings_" + e + "_ts", l), t.put("lastSyncableUpdatedItem", l)), n.user && i.sync && !s
						.doNotSaveToCloud && r.emit("_cloudSync")
				}
			...
			h = function (n) {
				...
				var i, s = e[n];
				return s ? (s.save && t.isAvbl ? null === (i = t.get("settings_" + n)) ? i = s.def : l(s, i) || (window.wError("store",
					"Attempt to get invalid value from localStorage", n), i = s.def) : i = s.def, a[n] = i, i) : (window.wError(
					"Trying to get invalid dataSpec. ident:", n), null)
			},
			f = function (t) {
				return e[t].def
			};
		...
		return h("firstUserSession") || d("firstUserSession", Date.now()), n.sessionCounter = h("sessionCounter201803") + 1, d(
			"sessionCounter201803", n.sessionCounter), s.emit("identityCreated", p), s.emit("provisionaryToken", t.get("userToken")), s.on(
			"tokenRecieved",
			function (e) {
	...
	W.define("dataSpecifications", ["rootScope", "utils"], function (e, t) {
		...
		return {
			...
			favOverlays: {
				def: ["radar", "satellite", "wind", "gust", "rain", "rainAccu", "snowAccu", "thunder", "temp", "rh", "clouds", "lclouds", "cbase",
					"visibility", "waves", "swell1", "swell2", "sst", "no2", "gtco3", "aod550", "pm2p5"
				],
				allowed: Array.isArray,
				save: !0,
				sync: !1
	...
	W.define("params", ["store", "models", "overlays", "utils", "broadcast", "products", "router", "renderCtrl"], function (e, t, n, i, s, a,
		r, o) {
		...
		e.setDefault("calendar", u), e.setDefault("path", u.ts2path(Date.now())), e.defineProperty("timestamp", "syncSet", function (t) {
			...
			return new Promise(function (n, s) {
				...
				a[e.get("product")].close(), r.open().then(function (s) {
					i.replaceClass(/product-\S+/, "product-" + t), s && (e.set("calendar", s), e.set("timestamp", i.bound(e.get("timestamp"), s.start,
							s.end), {
							forceChange: !0
						})), r.levels && (e.set("availLevels", r.levels), r.levels.includes(e.get("level")) || e.set("level", "surface")), r.acTimes &&
						(e.set("availAcTimes", r.acTimes), r.acTimes.includes(e.get("acTime")) || e.set("acTime", r.acTimes[0])), /^gfs/.test(t) ? e.set(
							"prefferedProduct", "gfs") : /^ecmwf/.test(t) && e.set("prefferedProduct", "ecmwf"), n(t)
				}).catch(s)
			})
		});
		var h, f = function (s) {
			var a = n[s];
			i.replaceClass(/overlay-\S+/, "overlay-" + s), i.toggleClass(document.body, a && a.hasMoreLevels, "has-more-levels"), e.set(
				"availProducts", t.overlay2product[s])
		};
		e.defineProperty("overlay", "asyncSet", function (n) {
			...
			window.wError("params", "failed to launch params change", t), e.set("product", "ecmwf", h), e.set("overlay", "wind", h), setTimeout(
				function () {
					d(), c()
				}, 500)
		})
	...
	W.define("Plugin", ["Class", "rootScope", "utils", "trans"], function (e, t, n, i) {
		return e.extend({
			...
			getAssetsLocation: function () {
				return this.location ? "http" === this.location.substr(0, 4) ? this.location : n.joinPath("https://www.windy.com/js", this.location) :
					t.assets + "/plugins/" + this.ident + ".js"
			},
			load: function () {
				var e = this;
				return this.isLoaded ? Promise.resolve(!0) : this.loading ? this.promise : (this.loading = !0, this.promise = new Promise(function (
					t, s) {
	...
	W.define("TagPlugin", ["Plugin", "Window", "trans"], function (e, t, n) {
		return e.extend(t, {
			...
			hasURL: !0,
			_init: function () {
				t._init.call(this), this.isLoaded = !1, this.loading = !1, this.isMounted = !1, this.cssInserted = !1, this.bodyClass = "on" + this
					.ident
			},
			_unmount: function () {
			...
			open: function (e) {
				var t = this;
				return this.closingTimer && clearTimeout(this.closingTimer), this.isLoaded ? (this.isMounted || this._mount(), this._open(e),
			...
			_mount: function () {
				...
				e ? (e.css && !this.cssInserted && (this.cssInserted = !0, document.head.insertAdjacentHTML("beforeend", "<style>" + e.css +
						"</style>")), this.createNode(e.html), n.translateDocument(this.node), this.attachRefs(), e.callback && "function" == typeof e.callback &&
					e.callback.call(this), this.isMounted = !0) : window.wError("plugin", "Error, tag: " + this.ident + " was not registered")
			}
		})
	}), /*! */
	...
	W.define("RiotPlugin", ["TagPlugin", "broadcast"], function (e, t) {
		return e.extend({
			...
			_unmount: function () {
				this.unmountOnClose && this.riotTag ? (this.riotTag.unmount(), this.node.parentNode.removeChild(this.node), this.isMounted = this.riotTag = !
					1) : this.node.style.display = "none"
			},
			_open: function (e) {
				var n = this,
					i = this.isOpen;
				if (!this.isOpen) {
					if (this.riotTag || (this.riotTag = riot.mount(this.ident)[0]), this.addHooks(), !this.riotTag) return void window.wError("plugin",
						"Unable to _open riot tag: ", this.ident);
				...
				this.riotTag.onopen && this.riotTag.onopen(e, i), this.riotTag.onurl && (this.onurl = this.riotTag.onurl), this.hasURL && this.url(
					e)
			}
		})
	}), /*! */
	...
	W.define("pluginsCtrl", ["rootScope", "plugins", "broadcast", "utils"], function (e, t, n, i) {
		...
		function a(n, a) {
			...
			o && (o.exclusive && ("all" === o.exclusive ? i.each(t, function (e, t) {
				e.isOpen && t !== n && r(t)
			}) : "rhpane" !== o.exclusive && "lhpane" !== o.exclusive || (t.detail.close(), t.rplanner.close(), t.station.close(), e.isMobile ?
				(s(n, "rhpane"), s(n, "lhpane")) : s(n, o.exclusive))), o.open(a))
		}
	...
	W.define("Bar", ["$", "utils", "Drag", "GhostBox", "Resizable", "rootScope"], function (e, t, n, i, s, a) {
		return s.extend(n, i, {
			...
			jumpingWidth: 140,
			_init: function () {
				this.left = 0, this.calendarHours = 0, this.timestamp = Date.now(), this.resizableEl = this.progressBar, this.el = this.timecode =
					e(".main-timecode", this.progressBar), this.text = e(".box", this.timecode), this.progressLine = e(".progress-line", this.progressBar),
					this.b = e(".progress-line i", this.progressBar), this.played = e(".progress-line .played", this.progressBar), this.ghost = e(
						".ghost-timecode", this.progressBar), this.ghostTxt = e(".box", this.ghost), n._init.call(this), s._init.call(this), a.isMobile ||
					i._init.call(this), this.progressLine.addEventListener("mouseup", this.click.bind(this)), this.ondragend = this.bcast.bind(this),
					this.throttledBcast = t.throttle.call(this, this.bcast, this.bcastLimit)
			},
			ondrag: function (e) {
				this.update(e + 20 - this.offset), this.throttledBcast()
			},
			update: function (e) {
				return this.left = t.bound(e, 0, this.maxWidth), this.timecode.style.left = this.left + this.offset + "px", this.text.textContent =
					this.createText(this.text), this.played && (this.played.style.width = this.left + "px"), this.left
			},
			createText: function () {},
			...
			onresize: function () {
				if (this.calendar) {
					if (this.progressWidth = this.progressBar.offsetWidth - this.offset, this.pxRatio = this.progressWidth / (this.calendar.endOfCal -
							this.calendar.start), this.maxWidth = this.ts2pos(this.calendar.end), this.progressLine.style.width = t.bound(this.maxWidth, 0,
							this.progressWidth) + "px", this.borderOffset = this.elLeft, this.b) {
			...
			updateGhost: function (e) {
				...
				this.ghost.style.left = n + this.offset + "px", this.jumpingGhost && (this.ghost.style["margin-top"] = this.left - n < 40 && n -
					this.left < this.jumpingWidth ? "-25px" : "0px"), this.ghostTxt.textContent = this.createGhostText(n)
			}
		})
	}), /*! */
	...
	W.define("BindedSwitch", ["$", "store", "Switch"], function (e, t, n) {
		return n.extend({
			_init: function () {
				this.initValue = t.get(this.bindStore), t.on(this.bindStore, this.set, this), "function" == typeof this.render && t.on("usedLang",
					this.render, this), n._init.call(this)
			},
			unmount: function () {
	...
	W.define("Drag", ["Class"], function (e) {
		return e.extend({
			...
			passiveListener: !0,
			_init: function () {
				this.dragging = !1, this.bindedDrag = this._drag.bind(this), this.bindedEndDrag = this.endDrag.bind(this), this.bindedStart = this.startDrag
					.bind(this), this.el.addEventListener("mousedown", this.bindedStart), this.supportTouch && this.el.addEventListener("touchstart",
						this.bindedStart)
			},
			destroy: function () {
			...
			startDrag: function (e) {
				this.preventDefault && e.preventDefault(), this.startXY = this.getXY(e), this.offsetX = -this.el.offsetLeft, this.offsetY = -this.el
					.offsetTop, this.dragging = !0, this.ondragstart && this.ondragstart.call(this, this.startXY), window.addEventListener("mousemove",
						this.bindedDrag), window.addEventListener("mouseup", this.bindedEndDrag), this.supportTouch && (window.addEventListener(
						"touchmove", this.bindedDrag, this.passiveListener ? void 0 : {
							passive: !1
			...
			endDrag: function (e) {
				window.removeEventListener("mousemove", this.bindedDrag), window.removeEventListener("touchmove", this.bindedDrag, this.passiveListener ?
						void 0 : {
							passive: !1
						}), window.removeEventListener("mouseup", this.bindedEndDrag), window.removeEventListener("touchend", this.bindedEndDrag), window
					.removeEventListener("touchcancel", this.bindedEndDrag), this.ondragend && this.ondragend(e), this.dragging = !1
			}
		})
	}), /*! */
	W.define("DraggableDiv", ["Class", "utils"], function (e, t) {
		return e.extend({
			...
			startDrag: function (e) {
				...
				var u = function () {
						clearInterval(d), window.removeEventListener("mousemove", f), window.removeEventListener("mouseup", u), Math.abs(s) > 10 && (r =
							.6 * s, o = n.scrollEl.scrollLeft + r, a = Date.now(), n.inertiaAnim = window.requestAnimationFrame(h)), e.preventDefault(), e.stopPropagation()
					},
					h = function () {
						var e = Date.now() - a,
							t = -r * Math.exp(-e / 325);
	...
	W.define("GhostBox", ["Class"], function (e) {
		return e.extend({
			_init: function () {
				this.progressLine.addEventListener("mouseenter", this.onGhostMouseEnter.bind(this)), this.progressLine.addEventListener(
					"mouseleave", this.onGhostMouseLeave.bind(this)), this.progressLine.addEventListener("mousemove", this.onGhostMouseMove.bind(this))
			},
		...
		return a.extend({
			...
			_render: function () {
				...
				o || s.each(e, function (t, n) {
					var i = t.virtual,
						s = t.parentMenu;
					i || !s || !a.includes(n) || !e[s].virtual || s in d || (d[s] = !0)
				});
				var f = i.overlays.map(function (t) {
					var n = e[t],
						i = n.allwaysOn,
						s = n.icon,
						r = n.trans,
						...
						f = t in d,
						m = a.includes(t) || i || f;
					if (!n || !r || !s || !m || o && h) return "";
					var p = l && (a.includes(l) || d[l]);
					l ? l in c ? c[l]++ : c[l] = 1 : u++;
					var g = n.getName();
					return '<a data-do="' + (h ? "unfold" : "set") + "," + t + '" data-parent="' + (l || "isParent") +
						'"\n\t\t\t\t\t\t\n\t\t\t\t\t\t' + (!o && l && p ? 'class="sub-menu"' : "") +
						'>\n\t\t\t\t\t\t<div class="iconfont noselect notap">' + s + '</div>\n\t\t\t\t\t\t<div class="menu-text noselect notap">' + g +
						"</div>\n\t\t\t\t\t</a>"
				}).join("");
				for (var m in f +=
						'<a data-do="toggle,overlays" id="ovr-menu"\n\t\t\t\t\t\n\t\t\t\t\tclass="menu-unfold">\n\t\t\t\t\t\t<div class="iconfont noselect notap">&lt;</div>\n\t\t\t\t\t\t<div class="menu-text noselect notap">' +
						n.MORE_LAYERS + "</div>\n\t\t\t\t\t</a>", c) h = Math.max(h, c[m]);
				this.iconNum = o ? 1 + a.length : u + h, this.el.innerHTML = f
			}
		})
	}), /*! */
			...
			redraw: function () {
				...
				this.el.innerHTML = this.menu.map(function (n) {
					var r = i.seaProducts.includes(n),
						...
						d = t[n];
					return a.includes(n) && o === r && l === c ? '<div data-do="set,' + n + '"' + (s.includes(n) ? "" : 'class="disabled"') + ">" +
						d.modelName + (e.showResolution && d.modelResolution ? "<small>" + d.modelResolution + "km</small>" : "") + "</div>" : ""
				}).join(""), this.set(r)
			}
		})
	}), /*! */
	W.define("Resizable", ["utils", "broadcast", "Class"], function (e, t, n) {
		return n.extend({
			resizableEl: null,
			_init: function () {
				window.addEventListener("resize", e.debounce(this.resize.bind(this), 300)), t.on("pluginOpened", this.uiChanged, this), t.on(
					"pluginClosed", this.uiChanged, this), t.on("detailRendered", this.resize, this), t.on("uiChanged", this.uiChanged, this), this.rects = {
					left: -1
				}, this.resize()
			},
			uiChanged: function () {
			...
			resize: function () {
				...
				e.compare(t, this.rects, ["left", "right", "top", "bottom"]) || (this.height = Math.max(1, t.height), this.width = Math.max(1, t.width),
					this.rects = t, this.elTop = t.top, this.elBottom = t.bottom, this.elLeft = t.left, this.elRight = t.right, this.onresize(this.rects)
				)
			},
			onresize: function () {}
		})
	...
	W.define("Scrollable", ["Class", "utils"], function (e, t) {
		return e.extend({
			...
			scrollFired: function (e) {
				this.scrollTicking || (window.requestAnimationFrame(this.onscroll.bind(this, e)), clearTimeout(this.scrollEndTimer), this.scrollEndTimer =
					setTimeout(this.onscrollend.bind(this), 100), this.scrollTicking = !0)
			},
			scrollTo: function (e) {
				var n = this,
	...
	W.define("Swipe", ["Class"], function (e) {
		return e.extend({
			...
			_swipeTresholdY: 50,
			_init: function () {
				this.xDown = null, this.yDown = null, this.el.addEventListener("touchstart", this.touchStart.bind(this)), this.el.addEventListener(
					"touchmove", this.touchMove.bind(this)), this.el.addEventListener("touchend", this.touchEnd.bind(this))
			},
			...
			touchEnd: function (e) {
				...
				Math.abs(t) > Math.abs(n) && Math.abs(t) > this._swipeTresholdX && Math.abs(n / t) < .2 ? this.onswipe(t > 0 ? "left" : "right", t,
					e) : Math.abs(n) > this._swipeTresholdY && Math.abs(t / n) < .2 && this.onswipe(n > 0 ? "up" : "down", n, e)
			},
	...
	W.define("Switch", ["$", "ClickHandler"], function (e, t) {
		return t.extend({
			...
			_init: function () {
				var e;
				this.el && this.initValue && (e = this.getEl(this.initValue)) && e.classList.add("selected"), this.selected = this.initValue, t._init
					.call(this)
			},
			getEl: function (t) {
			...
			click: function (t, n, i) {
				if ("set" === t) {
					var s = e(".selected", this.el),
						a = this.getEl(n);
					s && s.classList.remove("selected"), a && a.classList.add("selected"), i || n !== this.selected && this.onset(n), this.selected =
						n
			...
			load: function (e) {
				...
				return this.removeMarker(), new Promise(function (n) {
					i.get("/node/webcams2/" + e.lat + "/" + e.lon, {
						...
						var i = e.data;
						t.daylight = !1, i.length > 0 ? (t.data = i.slice(0, t.maxAmount), t.render()) : (t.data = [], t.el && (t.el.innerHTML = "")),
							n(t.data)
					})
				})
			},
				...
				if (this.data && this.data.length) {
					...
					this.el.innerHTML = this.data.map(function (e, t) {
						...
						return '<div class="webcam" data-do="webcam,' + t + '" data-webcam="' + t +
							'"\n\t\t\tstyle="background-image: url( img/ajax-loader.gif );">\n\t\t\t<div class="iconfont" data-do="lookr,' + t +
							'" data-tooltip="' + n.D_WEBCAMS_24 + '">&#xe041;</div>\n\t\t\t<div class="wbcm-name noselect">' + o +
	...
	W.define("BindedBar", ["store", "Bar", "format"], function (e, t, n) {
		return t.extend({
			...
			_init: function () {
				t._init.call(this), e.on("usedLang", this.render, this), e.on("hourFormat", this.render, this), e.on("zuluMode", this.render, this),
					e.on(this.bindTimestamp, this.ontstamp, this), e.on(this.bindCalendar, this.setCal, this), this.ondragstart = this.stopAnim, this.setCal(
						e.get(this.bindCalendar)), this.set(e.get(this.bindTimestamp))
			},
			render: function () {
				this.zuluMode = e.get("zuluMode"), delete this.text.dataset.zulu, this.displayHour = n.getHoursFunction(), this.text.textContent =
	...
	W.define("Window", ["$", "trans", "Class", "broadcast"], function (e, t, n, i) {
		return n.extend({
			...
			timeout: null,
			_init: function () {
				this.isOpen = !1, this.closingTimer = null, this.timeoutTimer = null, this.bindedClose = this.close.bind(this), this.bodyClass =
					"on" + this.iAm + "-" + this.ident
			},
			removeHooks: function () {
				this.closeOnClick && (document.removeEventListener("mousedown", this.bindedClose, !0), document.removeEventListener("touchstart",
					this.bindedClose, !0)), this.keyboard && this.node.removeEventListener("keydown", this.keyCatcher)
			},
			addHooks: function () {
				this.closeOnClick && (document.addEventListener("mousedown", this.bindedClose, !0), document.addEventListener("touchstart", this.bindedClose, !
					0)), this.keyboard && this.node.addEventListener("keydown", this.keyCatcher)
			},
			close: function (e) {
				var t = this;
				this.isOpen && (this.isOpen = !1, document.body.classList.remove(this.bodyClass), this.node.classList.remove("open"), this.closingTimer =
					setTimeout(function () {
						t._unmount(), i.emit("pluginClosed", t.ident)
					}, 500), "function" == typeof this.onclose && this.onclose(e), this.removeHooks(), this.hasURL && W.location.reset(), !this.closeOnClick &&
			...
			createNode: function (t) {
				this.node = this.el = this.element = document.createElement("div"), this.node.id = this.htmlID || this.iAm + "-" + this.ident, this
					.className && (this.node.className = this.className), this.node.innerHTML = '<div class="closing-x"></div>' + t;
				var n = this.domEl || e(this.attachPoint);
				this.replaceMountingPoint ? n.parentElement.replaceChild(this.node, n) : n.appendChild(this.node), e(".closing-x", this.node).onclick =
					this.bindedClose
			},
			...
			open: function (e) {
				return this.closingTimer && clearTimeout(this.closingTimer), this.timeoutTimer && clearTimeout(this.timeoutTimer), this.isOpen || (
					this._mount(), this._open(e)), this
			},
			attachRefs: function () {
				this.refs = {};
			...
			_open: function (e) {
				var t = this;
				this.isOpen || (document.body.classList.add(this.bodyClass), this.displayBlock && (this.node.style.display = "block"), this.addHooks(),
						setTimeout(function () {
							t.node.classList.add("open"), i.emit("pluginOpened", t.ident)
						}, 50), this.isOpen = !0, this.timeout && (this.timeoutTimer = setTimeout(this.close.bind(this), this.timeout))), this.onopen(e),
	...
	W.define("DropDown", ["Switch", "$"], function (e, t) {
		return e.extend({
			_init: function () {
				e._init.call(this), this.opened = !1, this.switch = t("ul", this.el), this.el.addEventListener("click", this.toggle.bind(this)),
					this.bindedClose = this.close.bind(this), this.fill()
			},
			fill: function () {
	...
	W.define("BindedDropDown", ["BindedSwitch", "DropDown", "store"], function (e, t, n) {
		return t.extend(e, {
			_init: function () {
				this.initValue = n.get(this.bindStore), n.on(this.bindStore, this.set, this), "function" == typeof this.render && n.on("usedLang",
					this.render, this), t._init.call(this)
			},
			set: function (t) {
	...
	W.define("TimestampBar", ["BindedBar", "format", "trans"], function (e, t, n) {
		return e.extend({
			...
			createText: function (e) {
				...
				return this.zuluMode && (e.dataset.zulu = t.hourUTC(this.timestamp)), "" + a + this.displayHour(Math.round(this.numberOfHours *
					this.left / this.progressWidth) % 24)
			},
	...
	W.define("components", ["radar", "products", "trans", "store", "query", "$", "utils", "rootScope", "broadcast", "overlays", "Class",
		"ClickHandler", "BindedSwitch", "BindedCheckbox", "TimestampBar"
	], function (e, t, n, i, s, a, r, o, l, c, d, u, h, f, m) {
		var p;
		h.instance({
			...
			el: a("#mobile-ovr-select"),
			_init: function () {
				this.debouncedRedraw = r.debounce(this.render.bind(this), 50), i.on("usedLang", this.render, this), i.on("level", this.debouncedRedraw),
					i.on("overlay", this.debouncedRedraw), i.on("product", this.debouncedRedraw), e.on("providerChanged", this.render, this), this.render()
			},
			render: function () {
				var e = i.get("overlay"),
					n = c[e],
					...
					a = i.get("level"),
					r = [];
				n.hasMoreLevels && "surface" !== a && r.push(o.levelsData[a][0].replace(/Pa/, "")), !/ecmwf/.test(s.ident) && s.modelName && s.modelName
					.length && r.push(s.modelName);
			...
			click: function (e) {
				switch (e) {
				case "openapp":
					window.location.href = "ios" === o.platform ? "https://apps.apple.com/app/apple-store/id1161387262?pt=118417623&ct=webapp&mt=8" :
	...
	W.define("calendarUI", ["$", "utils", "rootScope", "trans", "store", "format", "Scrollable"], function (e, t, n, i, s, a, r) {
		n.isMobile && r.instance({
			...
			UIident: "botomCal",
			_init: function () {
				r._init.call(this), s.on("timestamp", this.set, this), s.on("hourFormat", this.render, this), s.on("calendar", this.render, this),
					s.on("usedLang", this.render, this), s.on("zuluMode", this.render, this), window.addEventListener("resize", setTimeout.bind(null,
						this.render.bind(this), 500)), setInterval(this.render.bind(this), t.tsHour), this.render(), this.set(s.get("timestamp"))
			},
			render: function () {
				var n = this;
				if (this.calendar = s.get("calendar"), this.zuluMode = s.get("zuluMode"), this.localeHours = a.getHoursFunction(), this.timestamp =
					0, this.calendar) {
					...
					delete this.box.dataset.zulu, this.set(m), this.renderBox(), e("b", this.scrollEl).style.left = window.innerWidth / 2 + (Date.now() -
						this.calendar.start) / this.tsPx + "px"
				}
			},
			slideUp: function () {
				this.scrolling || this.noAnimation || (this.scrolling = !0, document.body.classList.add("mobile-scroll")), this.noAnimation && (
					this.scrolling = !0, this.noAnimation = !1)
			},
			onscroll: function (e) {
				this.slideUp(), this.timestamp = this.tsPx * e.target.scrollLeft + this.calendar.start, this.renderBox(), this.scrollTicking = !1
			},
			renderBox: function () {
				this.zuluMode && (this.box.dataset.zulu = a.hourUTC(this.timestamp)), this.box.textContent = this.localeHours(new Date(this.timestamp)
					.getHours())
			},
			onscrollend: function () {
	...
	W.define("calendarUIdesktop", ["store", "$", "trans", "rootScope", "ClickHandler", "Resizable"], function (e, t, n, i, s, a) {
		if (!i.isMobile) {
			...
			s.instance(a, {
				...
				stopPropagation: !0,
				_init: function () {
					s._init.call(this), a._init.call(this), e.on("calendar", this.render, this), e.on("usedLang", this.render, this), this.onresize =
						this.render.bind(this), this.click = e.set.bind(e, "timestamp"), this.render()
				},
				render: function () {
	...
	W.define("loadersUI", ["broadcast", "utils"], function (e, t) {
		var n = t.debounce,
			i = !1;
		var s = n(function () {
			i = !0, document.body.classList.remove("loading-overlay"), document.body.classList.remove("loading-path"), document.body.classList.remove(
				"loading-level")
		}, 300);
	...
	W.define("timeAnimation", ["utils", "store", "products", "broadcast"], function (e, t, n, i) {
		...
		t.on("animation", function (e) {
			e !== r && (e ? function () {
				...
				r = !0, a = s = t.get("path"), c = 2, t.on("visibility", h), t.on("product", p), t.on("overlay", m), i.on("redrawFinished", f), i.on(
					"paramsChanged", g), i.on("pluginOpened", p), v(), i.emit("animationStarted")
			}() : (r = !1, clearTimeout(o), t.off("visibility", h), t.off("product", p), t.off("overlay", m), i.off("redrawFinished", f), i.off(
				"paramsChanged", g), i.off("pluginOpened", p)))
		});
		var h = function (e) {
				e || p()
			},
	...
	W.define("Renderer", ["plugins", "Class"], function (e, t) {
		return t.extend({
			...
			open: function (t) {
				var n = this;
				return this.isMounted ? Promise.resolve() : this.isLoaded ? (this.onopen(t), this.isMounted = !0, Promise.resolve()) : this.loadingPromise ?
					this.loadingPromise : (this.loadingPromise = new Promise(function (i) {
		...
		return s.extend({
			...
			postProcess: function (e, t, n, s) {
				if (e === this.syncCounter) {
					...
					this.trans = 0 | i.getTrans(t.zoom, t.dZoom), this.shift = 0 | Math.log2(this.trans), this.lShift = 0 | Math.log2(this.trans *
						this.trans);
					var r = t.pixelOriginX / this.trans % 256,
						o = t.pixelOriginY / this.trans % 256;
					r < 0 && (r = 256 + r), this.offsetX = r * this.trans | 0, this.offsetY = o * this.trans | 0, this.offset = 2056, this.width = t.width,
						this.height = t.height, this.w = i.getWTable(this.trans), this.tilesReady.call(this, a, t, n)
				}
			},
	...
	W.define("Particles", ["Class", "store"], function (e, t) {
		return e.extend({
			...
			getBlendingAlpha: function (e) {
				var t = .9 * (this.configurable && 1 != this.config.blending ? this.config.blending : 1) * (e.speed2pixel < .8 ? 1 + (.8 - e.speed2pixel) /
					7 : 1);
	...
	W.define("TileLayerCanvas", ["rootScope", "render", "utils", "dataLoader", "renderTile"], function (e, t, n, i, s) {
		return L.GridLayer.extend({
			...
			onAdd: function (e) {
				L.GridLayer.prototype.onAdd.call(this, e), e.on("movestart", this.onMoveStart, this), e.on("moveend", this.onMoveEnd, this), this.on(
					"load", this.checkLoaded, this)
			},
			onRemove: function (e) {
				e.off("movestart", this.onMoveStart, this), e.off("moveend", this.onMoveEnd, this), this.off("load", this.checkLoaded, this), L.GridLayer
					.prototype.onRemove.call(this, e), this.hasSea = !1, document.body.classList.remove("sea"), t.emit("toggleSeaMask", this.hasSea)
			},
			...
			paramsChanged: function (e) {
				e.fullPath === this.latestParams.fullPath && e.layer === this.latestParams.layer || (this.latestParams = n.clone(e), this.syncCounter++,
					this.redrawLayer())
			},
			...
			redrawFinished: function () {
				this.latestParams.sea !== this.hasSea && (n.toggleClass(document.body, this.latestParams.sea, "sea"), this.hasSea = this.latestParams
					.sea, t.emit("toggleSeaMask", this.hasSea)), t.emit("rendered", "tileLayer")
			},
	...
	W.define("dataLoader", ["store", "lruCache", "rootScope", "utils", "broadcast"], function (e, t, n, i, s) {
		...
		function d(e, t) {
			return this.url = e, this.status = "undefined", this.data = null, this.x = t.x, this.y = t.y, this.z = t.z, this.transformR = t.transformR,
				this.transformG = t.transformG, this.transformB = t.transformB, this
		}
				...
				a.crossOrigin = "Anonymous", a.onload = function () {
					...
					var i = function (e, t) {
							var n, i, s, a, r = new ArrayBuffer(28),
								...
								c = 4 * t * 4 + 8;
							for (a = 0; a < 28; a++) n = e[c], i = e[c + 1], s = e[c + 2], n = Math.round(n / 64), i = Math.round(i / 16), s = Math.round(s /
								64), o[a] = (n << 6) + (i << 2) + s, c += 16;
							return l
						}(e.data, 257),
						s = i[0],
						o = (i[1] - i[0]) / 255,
	...
	W.define("render", ["Evented"], function (e) {
			...
			case 2:
				return function (t, n, a) {
					var r = (n << 8) + t << 2,
						...
						c = i[o++],
						d = i[o];
					e[r] = e[r + 4] = l, e[r + 1] = e[r + 5] = c, e[r + 2] = e[r + 6] = d, e[r += 1024] = e[r + 4] = l, e[r + 1] = e[r + 5] = c, e[r +
						2] = e[r + 6] = d
				}
			}
		};
		var i = document.createElement("canvas"),
			s = i.getContext("2d");
		return i.width = i.height = 256, s.fillStyle = "black", s.fillRect(0, 0, 256, 256), t.imgData = s.getImageData(0, 0, 256, 256), t.interpolateNearest =
			function (e, t, n, i, s, a, r, o, l, c) {
	...
	W.define("renderers", ["Renderer", "testWebGl", "map", "plugins", "tileLayer", "utils", "tileInterpolator"], function (e, t, n, i, s, a, r) {
		...
		l.tileLayer = o.instance(), l.tileLayerPatternator = o.instance({
			...
			dependency: "radar",
			onopen: function () {
				this.onopen = i.radar.onopen, this.onclose = i.radar.onclose, this.redraw = i.radar.onredraw, this.interpolator = W.require(
					"radarInterpolator")
			}
		}), l.satellite = e.instance({
			dependency: "satellite",
			onopen: function () {
				this.onopen = i.satellite.onopen, this.onclose = i.satellite.onclose, this.redraw = i.satellite.onredraw, this.interpolator = W.require(
		...
		var c = e.instance({
			...
			d = e.instance({
				...
				onopen: function (e) {
					...
					this.paramsChanged = t.paramsChanged, this.onclose = t.close, this.redraw = t.redraw, t.open(e) || (l.particles = c, this.close(),
						c.open(e))
				}
			});
		return l.particles = t.useGLparticles() ? d : c, l.map = e.instance({
			...
			onopen: function () {
				var e = i["map-layers"];
				this.onopen = e.onopen, this.onclose = e.onclose, this.redraw = a.emptyFun, this.paramsChanged = a.emptyFun, this.interpolator = W.require(
				...
				var a = this,
					r = function (e, i) {
						...
						var y = g[v],
							...
							N = m * m,
							I = (y * P + w * D + E * O + A * R) / N,
							W = s.interpolateNearestG ? t.interpolateNearest(null, 0, b, T, M, C, P, D, O, R) : (b * P + T * D + M * O + C * R) / N,
							k = (L * P + S * D + _ * O + x * R) / N;
						return [p.decodeR(I), p.decodeG(W), p.decodeB(k)]
					};
				this.cb(function (t) {
					var n = t.lat,
						i = t.lon,
	...
	W.define("renderTile", ["render", "layers"], function (e, t) {
		return function (n, i, s, a, r) {
			if (s === this.syncCounter) {
				...
				var f, m, p, g, v, y, w, b, T, L, S, E, A = !1,
					M = 0 | a.trans,
					C = 0 | Math.log2(M),
					_ = 0 | Math.log2(M * M),
					x = 0 | a.intX,
					...
					te = r.decodeR,
					ne = r.decodeG;
				for (l ? (T = e.createCombinedFillFun(u, $.getColor(), $.getColor2(), $.getAmountByColor), L = e.createFillFun(u, n, $.getColor())) :
					T = L = e.createFillFun(u, n, $.getColor()), K && (te = r.decodeB), E = 0; E < 256; E += n)
					for (B = E - ((F = E >> C) << C), S = 0; S < 256; S += n) H = S - ((U = S >> C) << C), G !== U && (N = 2056 + U + I + (((z = F + k) <<
							8) + z) << 2, void 0 !== h && (A = h(c, N)), !0 === K && (N += 2), V = c[N], j = c[N + 4], Y = c[N + 1028], Z = c[N + 1032], !0 ===
						ee && (X = c[N + 1], q = c[N + 5], Q = c[N + 1029], J = c[N + 1033]), G = U), A ? L(S, E, NaN) : (w = te(null !== O ? V * O[R = H +
						(B << C) << 2] + j * O[R + 1] + Y * O[R + 2] + Z * O[R + 3] >> _ : V * (f = (1 - (v = H / M)) * (1 - (y = B / M))) + j * (m = v *
						(1 - y)) + Y * (p = y * (1 - v)) + Z * (g = v * y)), !0 === ee && (b = ne(null !== O ? X * O[R] + q * O[R + 1] + Q * O[R + 2] + J *
						O[R + 3] >> _ : X * f + q * m + Q * p + J * g)), l ? T(S, E, w, b) : T(S, E, ee ? Math.sqrt(w * w + b * b) : w));
				d.putImageData(e.imgData, 0, 0), "pattern" in o && o.pattern in W && W[o.pattern].addPattern(d, M, c, 2056, I, k, D, te, ne)
			}
		}
	}), /*! */
	W.define("GlObj", [], function () {
		...
		return e.getNextPowerOf2Size = function (e) {
			...
			reset: function () {
				this.framebuffers = [], this.buffers = [], this.shaders = [], this.programs = [], this.textures = [], this.gl = null, this.canvas =
					null
			},
			create: function (e, t, n) {
				if (this._id = n || "noname", !this.gl && !this.canvas) return this.canvas = e, this.gl = e.getContext("webgl", t) || e.getContext(
					"experimental-webgl", t), this.gl
			},
			get: function () {
				return this.gl
			},
			...
			createShader: function (e, t, n) {
				...
				if (this.keepRefsShaders && this.shaders.push(s), i.shaderSource(s, e), i.compileShader(s), !i.getShaderParameter(s, i.COMPILE_STATUS)) {
					...
					throw a.contextLost = i.isContextLost(), a.isVertexShader = t, a.name = n, a.full = "ERROR compileShader! name: " + a.name + "; " +
						(a.isVertexShader ? "VS" : "FS") + "; " + (a.contextLost ? "contextLost" : "NOT contextLost") + "; msg: " + a.message, a
				}
				return s
			},
			createProgramObj: function (e, t, n, i) {
				...
				if (r.attachShader(o, d), r.attachShader(o, u), r.linkProgram(o), !r.getProgramParameter(o, r.LINK_STATUS)) throw (a = new Error(r.getProgramInfoLog(
					o))).contextLost = r.isContextLost(), a.name = i, a.full = "ERROR linkProgram! name: " + a.name + "; " + (a.contextLost ?
					"contextLost" : "NOT contextLost") + "; msg: " + a.message, a;
			...
			createTexture2D: function (e, t, n, i, s, a, r) {
				var o = this.get(),
					l = o.createTexture();
				return this.keepRefs && this.textures.push(l), l._width = s, l._height = a, o.bindTexture(o.TEXTURE_2D, l), this.setBindedTexture2DParams(
					e, t, n), this.resizeTexture2D(l, i, s, a, r)
			},
			...
			resizeTexture2D: function (e, t, n, i, s) {
				var a = this.get();
				return s = s || a.RGBA, e._width = n, e._height = i, e._format = s, a.bindTexture(a.TEXTURE_2D, e), null === t || t instanceof Uint8Array ?
					a.texImage2D(a.TEXTURE_2D, 0, s, n, i, 0, s, a.UNSIGNED_BYTE, t) : a.texImage2D(a.TEXTURE_2D, 0, s, s, a.UNSIGNED_BYTE, t), a.bindTexture(
						a.TEXTURE_2D, null), e
			},
			setBindedTexture2DParams: function (e, t, n) {
				var i = this.get();
				i.texParameteri(i.TEXTURE_2D, i.TEXTURE_MIN_FILTER, e), i.texParameteri(i.TEXTURE_2D, i.TEXTURE_MAG_FILTER, t), i.texParameteri(i.TEXTURE_2D,
					i.TEXTURE_WRAP_S, n), i.texParameteri(i.TEXTURE_2D, i.TEXTURE_WRAP_T, n)
			},
			...
			createIndexBuffer: function (e) {
				var t = this.get(),
					n = t.createBuffer();
				return this.keepRefs && this.buffers.push(n), t.bindBuffer(t.ELEMENT_ARRAY_BUFFER, n), t.bufferData(t.ELEMENT_ARRAY_BUFFER, e, t.STATIC_DRAW),
					n
			},
	...
	W.define("testWebGl", ["GlObj", "store", "storage", "rootScope"], function (e, t, n, i) {
		return {
			...
			initWebGl: function () {
				...
				try {
					...
					e = this.glo.create(t, {
						...
						}, "testWebGl"), this.it.gl = e, e ? this.it.framebuffer = this.glo.createFramebuffer() : window.WebGLRenderingContext ? this.status =
						"error-no-WebGL-context" : this.status = "error-no-WebGL-browser"
				} catch (e) {
			...
			startParticleUpdateTest: function () {
				return this.renderParticleUpdateTest(1 / 255.5, 255, .125 / 255, -1 / 255), this.compareDataFast(this.it.data0, this.it.data1) > 1e3 ?
					"no-particles-update" : this.retOk
			},
			initParticleUpdateTest: function () {
				var e = this.glo,
					t = e.get();
				if (this.shaderErrors = 0, this.it.shEncodeDecode = this.compileShader(this.shRectVS, this.shEncodeDecodeFS, null, "EncodeDecode",
						"glParticlesTest"), this.shaderErrors > 0) return this.status = "error-shader-compilation", !1;
				this.it.vertexBufferRect = e.createBuffer(new Float32Array([-1, -1, 1, -1, 1, 1, -1, 1])), this.it.w = 128, this.it.h = 256, this.it.data0 =
					new Uint8Array(this.it.w * this.it.h * 4), this.it.data1 = new Uint8Array(this.it.w * this.it.h * 4);
				var n, i, s = 0;
				for (i = 0; i < this.it.h; i++)
					for (n = 0; n < this.it.w; n++) this.it.data0[s++] = n + n, this.it.data0[s++] = n + n + 1, this.it.data0[s++] = i, this.it.data0[s++] =
						i;
				return this.it.texture0 = e.createTexture2D(t.NEAREST, t.NEAREST, t.REPEAT, this.it.data0, this.it.w, this.it.h), this.it.texture1 =
					e.createTexture2D(t.NEAREST, t.NEAREST, t.REPEAT, this.it.data1, this.it.w, this.it.h), !0
			},
			renderParticleUpdateTest: function (e, t, n, i) {
				...
				a.useProgram(r.program), s.bindAttribute(this.it.vertexBufferRect, r.aPos, 2, a.FLOAT, 0, 8, 0), s.bindTexture2D(this.it.texture0, 0,
					r.sTex0), a.uniform4f(r.uPars, e, t, n, i), a.drawArrays(a.TRIANGLE_FAN, 0, 4), a.readPixels(0, 0, this.it.w, this.it.h, a.RGBA, a.UNSIGNED_BYTE,
					this.it.data1), s.bindFramebuffer(null)
			},
	...
	W.define("ImageGraph", ["ImageMaker"], function (e) {
		return e.extend({
			...
			createGradient: function (e, t, n) {
				for (var i, s, a = this.fillColors.length, r = this.fillColors[0][0], o = this.fillColors[a - 1][0], l = 1 / (o - r), c = this.h /
						(e - t), d = c * (o - t), u = c * (r - t), h = this.ctx.createLinearGradient(0, u, 0, d), f = 0; f < a; ++f) s = this.fillColors[
					f][1], i = l * (this.fillColors[f][0] - r), h.addColorStop(i, "rgba( " + s[0] + ", " + s[1] + ", " + s[2] + ", " + n + " )");
				return h
			},
			maskEnds: function (e) {
				var t = this.ctx,
					n = t.createLinearGradient(0, 0, e, 0);
				return t.globalCompositeOperation = "destination-out", n.addColorStop(0, "rgba(255,255,255,1)"), n.addColorStop(1,
						"rgba(255,255,255,0)"), t.fillStyle = n, t.fillRect(0, 0, e, this.h), (n = t.createLinearGradient(this.w - e, 0, this.w, 0)).addColorStop(
						0, "rgba(255,255,255,0)"), n.addColorStop(1, "rgba(255,255,255,1)"), t.fillStyle = n, t.fillRect(this.w - e, 0, this.w, this.h),
					this
			},
			...
			render: function (e, t) {
				...
				return s.lineTo(c[a + 2][0], l), this.fillColors ? (s.fillStyle = this.createGradient(h, f, t), s.fill()) : (s.lineWidth = this.lineWidth,
					s.strokeStyle = this.strokeStyle, s.stroke()), this.bottomWhitten && this.whiteBottom(s, t), this
			},
			whiteBottom: function (e, t) {
				var n = .5 * this.h,
					i = e.createLinearGradient(0, n, 0, this.h);
				t < 1 && (e.globalCompositeOperation = "destination-out"), i.addColorStop(0, "rgba(255,255,255,0.0)"), i.addColorStop(1,
					"rgba(255,255,255,1.0)"), e.fillStyle = i, e.fillRect(0, n, this.w, .5 * this.h)
			}
		})
	}), /*! */
	W.define("ImageMaker", ["Class"], function (e) {
		return e.extend({
			...
			init: function (e, t, n, i) {
				var s = t * n;
				return this.num = t, this.canvas = e, this.ctx = this.canvas.getContext("2d"), this.tdWidth = n, this.w = s, this.h = i, this.canvas
					.width = t * this.getPixelRatioAdjustedSize(n), this.canvas.height = this.getPixelRatioAdjustedSize(i), this.canvas.style.width =
					s + "px", this.canvas.style.height = i + "px", this.resetCanvas()
			},
			...
			dayNight: e.extend({
				...
				render: function (e) {
					for (var t = e.isDay, n = 0; n < t.length; n++) {
						...
						this.ctx.fillStyle = this.nightColor, 1 === i ? this.ctx.clearRect(s, 0, a, this.h) : 0 === i ? this.ctx.fillRect(s, 0, a, this.h) :
							i < 0 ? (this.ctx.clearRect(s, 0, r, this.h), this.ctx.fillRect(r, 0, a, this.h)) : (this.ctx.fillRect(s, 0, r, this.h), this.ctx
								.clearRect(r, 0, a, this.h))
					}
					return this
				}
			})
		...
		return r.extend({
			weatherData: function (e, t) {
				...
				var i = t.history,
					...
					a = e.summary;
				n = n || 7, a[s[s.length - 1]].segments < 3 && s.pop(), !i && a[s[1]].timestamp < Date.now() && s.shift(), s.length > n && (s = s.slice(
					0, n));
				var r = a[s[0]].index,
			...
			renderSliderDays: function () {
				...
				return this.giveMeDays(function (a, r) {
					...
					n += '<td width="' + 100 * r / t.dataLength + '%"', n += r > 3 ? ' data-afterbegin="' + a.weekday + '2"><img\n\t\t\t\tsrc="' + e
						.iconsDir + "/png_" + i + "px/" + a.icon + o + '.png"\n\t\t\t\tsrcset="' + e.iconsDir + "/png_" + i + "@2x/" + a.icon + o +
			...
			renderRainSnow: function () {
				for (var e = this.dataLength, t = "", n = this.data.snow, i = this.data.mm, s = 0; s < e; s++) {
					var a = null;
					n[s] && i[s] > .1 ? a = "&#xe000" : !n[s] && i[s] > .5 && (a = "&#xe006"), a && (t += '<i style="left: ' + s / e * 100 + '%">' + a +
						"</i>")
				}
				return t
			},
			...
			renderFragment: function (e, s, a) {
				...
				n.temp.init(t("canvas", e), this.dataLength, o, a.bgHeight).render(this.data.temp, .5).maskEnds(10), t(".slider", e).style.background =
					this.renderSlider(), r.innerHTML = "<tr> " + this.renderSliderDays() + "</tr>";
				var l = t(".alerts-line", e);
				if (a.timestamps && l ? (l.style.background = this.renderAlert(a.timestamps), l.style.display = "block") : l && (l.style.display =
						"none"), a.addRain) {
	...
	W.define("LabelsLayer", ["products", "http", "rootScope", "utils", "overlays", "store", "broadcast", "singleclick"], function (e, t, n, i,
		s, a, r, o) {
		return L.GridLayer.extend({
			options: {
				minZoom: 3,
			...
			syncCounter: 0,
			onAdd: function () {
				this.hasHooks || (this.updateProduct(), this.createTilesUrl(), o.on("poi-label", this.onClick, this), a.on("timestamp", this.onTsChange,
					this), a.on("usedLang", this.updateLabels, this), a.on("englishLabels", this.updateLabels, this), a.on("product", this.updateProduct
					.bind(this, "refresh")), r.on("metricChanged", this.refreshWeather, this), this.hasHooks = !0), L.GridLayer.prototype.onAdd.call(
					this)
			},
			createTilesUrl: function () {
				var e = a.get("englishLabels") ? "en" : a.get("usedLang");
				this.tilesUrl = n.tileServer + "/labels/v1.3/" + e, this.fcstUrl = "https://ims-s.windy.com/forecast/citytile/v1.3"
			},
			...
			createTile: function (e, n) {
				...
				return a.style.width = a.style.height = this.getTileSize() + "px", a.onselectstart = a.onmousemove = L.Util.falseFn, t.get(this.tilesUrl +
					"/" + s + ".json").then(this.onTileLoaded.bind(this, this.syncCounter, e, a)).then(function (e) {
					e && (e.urlFrag = s, i.loadFcstTile(e), n(void 0, a))
				}).catch(n), a
			},
			renderTile: function (e, t, n) {
				for (var s = this._getTilePos(t), a = s.x, r = s.y, o = this._map.getPixelOrigin(), l = o.x, c = o.y, d = 256 << t.z, u = [], h = 0; h <
					n.length; ++h) {
					var f = n[h],
						m = f[0],
						p = f[1],
						...
						E = Math.floor(i.latDegToYUnit(y) * d - c - b / 2) - r,
						A = document.createElement("div");
					A.textContent = A.dataset.label = p, A.dataset.id = L, A.dataset.poi = "label", A.className = g, A.style.transform = "translate(" +
						S + "px, " + E + "px)", A.style.width = w + "px", T || u.push({
							id: L,
							el: A
						}), e.appendChild(A)
				}
	...
	W.define("map", ["render", "plugins", "WindyMap", "rootScope", "utils", "store", "broadcast", "geolocation", "router"], function (e, t, n,
		i, s, a, r, o, l) {
		...
		c = new n("map-container", {
			...
			}), p(), g(), m(a.get("graticule")), c.on("moveend", p), c.on("movestart", r.emit.bind(r, "movestart")), r.on("zoomIn", c.zoomIn, c), r
			.on("zoomOut", c.zoomOut, c), r.on("updateBasemap", g), a.on("map", g), a.on("graticule", m), e.on("toggleSeaMask", function (e) {
				...
				}).addTo(c), c.seaLayer.getContainer().classList.add("sea-mask-layer")) : !e && c.seaLayer && (c.removeLayer(c.seaLayer), c.seaLayer =
					null)
			});
		var f = null;
		...
		function g() {
			var e = i.tileServer + "/tiles/v9.0/darkmap" + (i.isRetina ? "-retina" : "") + "/{z}/{x}/{y}.png",
				t = a.get("map");
			h[t] || h.sznmap, a.get("overlay");
			c.baseLayer && c.removeLayer(c.baseLayer), c.baseLayer = L.tileLayer(e, {
				detectRetina: !1,
				minZoom: 3,
				maxZoom: 11,
				updateWhenIdle: !!i.isMobileOrTablet,
	...
	W.define("promo", ["utils"], function (e) {
		var t = e.emptyFun;
		return {
			getCounter: t,
			getCounter2: t,
	...
	function () {
		...
		var e = window.W.windyBoot,
			...
			u = "pro" !== r && (!n || n && l),
			h = function (e) {
				c && console.log("Initalizing Windy API: " + e)
			},
			f = function (e) {
				throw new Error("Windy API error: " + e)
			};
		h("Checking Leaflet library"), L || f("Leaflet is missing. Add Leaflet to the HTML head tag."), /^1\.4/.test(L.version) || f(
			"Wrong version of Leaflet library. Version 1.4.x is required");
		! function () {
			var e = d("rootScope");
			if ("pro" === r) {
				var t = function (e, t) {
					...
					i = ["capAlerts", "radar", "nems", "map", "radarSat", "airQ"];
				e.overlays = t(e.overlays, i), e.localProducts = t(e.localProducts, i), e.globalProducts = t(e.globalProducts, i)
			} else n ? (e.localProducts = ["namConus", "namHawaii", "namAlaska", "iconEu", "arome"], e.globalProducts = ["gfs", "sea", "geos5",
				"gfsWaves", "iconGlobal", "satellite"
			], e.seaProducts = ["sea", "gfsWaves"], e.overlays = ["wind", "gust", "gustAccu", "rain", "rainAccu", "snowAccu", "snowcover", "ptype",
				"temp", "dewpoint", "rh", "deg0", "clouds", "hclouds", "mclouds", "lclouds", "fog", "cape", "waves", "swell1", "swell2", "wwaves",
				"currents", "cosc", "dustsm", "so2sm", "pressure", "satellite"
			], e.isolines = ["off", "pressure", "gh", "temp"]) : (e.localProducts = [], e.globalProducts = ["gfs", "sea", "gfsWaves"], e.overlays = [
				"wind", "rain", "temp", "clouds", "waves", "currents", "pressure"
			], e.isolines = ["off", "pressure", "gh", "temp"]);
		...
		var m = function () {
				var e = d("libHtml"),
					...
					a = d("trans"),
					r = d("rootScope");
				h("Adding HTML to #windy DIV");
				var o = t("#windy");
				o || f('Missing <div id="windy"></div> in the BODY of the page'), o.innerHTML = e.replace("__APIUSER__", i), o.classList.add(n ?
					"paid-model" : "free-model"), setTimeout(function () {
					a.translateDocument(o), h("Adding start-up options"), p(s, r), h("Initalizing rest of Windy API"), g()
				}, 50)
			},
			p = function (e) {
				var i = d("rootScope"),
					s = t.favOverlays || i.overlays,
					a = !n;
				if (e.setDefault("favOverlays", s), e.setDefault("expertMode", t.expertMode || a), (t.lat || t.lon || t.lng) && (e.set("startUp",
						"location"), e.set("homeLocation", {
						lat: t.lat,
						lon: t.lon || t.lng,
						zoom: t.zoom || 5
					})), "basic" === r) {
					e.setDefault("product", "gfs"), e.setDefault("prefferedProduct", "gfs"), e.setDefault("availProducts", ["gfs"]), e.setDefault(
						"visibleProducts", ["gfs"])
				}["overlay", "level", "particles", "numDirections", "lang", "disableWebGL", "graticule", "particlesAnim", "timestamp", "isolines",
					"isImperial", "latlon", "hourFormat"
				].forEach(function (n) {
					n in t && e.setDefault(n, t[n])
				})
			},
			g = function () {
				var e = d("picker"),
					...
					p = d("colors"),
					g = d("ga").pageview;
				W.loadOrphanedModules(), h("Done. Calling your windyInit callback"), e.open = function (e) {
					return l.emit("rqstOpen", "picker", e)
				}, e.close = function () {
					return l.emit("rqstClose", "picker")
				}, t.overlay && n.set("overlay", t.overlay), g(r.version + "/" + i + "-" + s + "/" + a), o({
					map: m,
					store: n,
					picker: e,
					utils: f,
					...
					console.log(
						"%c 🏄 Welcome to Windy JavaScript API. Please do not remove or conceal the Windy logo or the advertisement. The logo and the advertisement must remain a clickable link, and must lead to its target URL. Please see https://api.windy.com/ for documentation and for more information.",
						"color: #9D0300; font-size: large")
				}, 200)
			},
			v = function () {
				var e = d("$"),
					t = d("trans"),
					n = d("plugins").patch;
				n.load.call(n).catch(function () {
					var n = e("#windy-app-promo");
					n.innerHTML = '<a id="open-in-app" data-do="openapp" class="clickable" data-t="MENU_MOBILE"></a>', t.translateDocument(n);
					var i = ["#d49500", "#d40000", "#d4009b", "#8400d4", "#2200d4", "#0d869a", "#177900", "#ad7100"],
						s = e("#open-in-app");
					s.style.display = "block";
					var a = 0;
					setInterval(function () {
						++a >= i.length && (a = 0), s.style["background-color"] = i[a]
					}, 12e3)
				})
			};
